...
const MlServiceDetailsData = {
  title: "Unleashing Intelligence with Data & ML",
  ...
  excerpt:
    "Harness the power of data to identify trends, anticipate patterns, and automate smarter decisions.",
  content: "",
  ...
  transformIntelligence: {
    title: `Transform with Intelligence: <br /> The Power of <span class="red-text">AI-Driven Solutions</span>`,
    subtitle: null,
    excerpt: `Artificial intelligence is behind today's most revolutionary inventions, not the future. Our AI solutions help you unlock efficiency, accuracy, and intelligence at scale, from improving customer experience and enabling smart governance to automating operations.`,
    description: null,
    cover: "https://smartlab-api.appswind.com/storage/page/54/Union.png",
    coverSd: null,
  },
  ...
  deliveryPurpose: {
    ...
    subtitle: null,
    excerpt:
      "We combine strategic thinking, human-centered design, and technology-led execution to deliver tailored solutions that drive real impact. Our approach is collaborative, flexible, and built around your goals—ensuring every step adds value.",
    description: null,
    cover: null,
    coverSd: null,
    items: [
      {
        ...
        slug: "cyber-security",
        excerpt: `<div> 
          <p> Apply state-of-the-art language models for domain-specific automation, insight generation, and content creation. Our LLM tools add intelligence to every word, whether it's in public marketing or customer service.</p>

          <ul class="flex flex-col gap-2 mt-4 ml-6 list-disc "> 
            <li>AI Chatbot Development</li>
            <li> Voice Assistant Integration</li>
            <li>Real-time Transcription & Summarization (OpenAI Whisper) </li>
            <li>Multilingual & Multimodal NLP Solutions </li>
            <li>Conversational Platforms (WhatsApp, Facebook, Web) </li>
          </ul>
      ...
      },
      {
        ...
        excerpt: `<div> 
          <p> Convert cameras and other visual inputs into intelligent sensors that can recognize faces and analyze data in real time. Use cutting-edge computer vision tools to provide automation, security, and intelligence in physical spaces.</p>
        </div>`,
        content: null,
        cover:
      ...
      },
      {
        ...
        excerpt: `<div> 
          <p> Deploy NLP-powered bots to create organic, real-time chat, voice, and social interactions. Engage intelligent virtual assistants to increase engagement, decrease manual assistance, and create flawless customer experiences.</p>
        </div>`,
        content: null,
        cover:
  ...
  caseStudy: {
    ...
    items: [
      {
        title: "AI-Powered Predictive Analytics for E-commerce Growth",
        subtitle: "",
        excerpt: ``,
        content: null,
        cover:
      ...
      {
        title: "2 AI-Powered Predictive Analytics for E-commerce Growth",
        subtitle: "",
        excerpt: ``,
        content: null,
        cover:
      ...
      {
        title: "3 AI-Powered Predictive Analytics for E-commerce Growth",
        subtitle: "",
        excerpt: ``,
        content: null,
        cover:
      ...
      {
        title: "4 AI-Powered Predictive Analytics for E-commerce Growth",
        subtitle: "",
        excerpt: ``,
        content: null,
        cover:
      ...
      {
        title: "5 AI-Powered Predictive Analytics for E-commerce Growth",
        subtitle: "",
        excerpt: ``,
        content: null,
        cover:
      ...
      {
        title: "6 AI-Powered Predictive Analytics for E-commerce Growth",
        subtitle: "",
        excerpt: ``,
        content: null,
        cover:
      ...
      {
        title: "7 AI-Powered Predictive Analytics for E-commerce Growth",
        subtitle: "",
        excerpt: ``,
        content: null,
        cover:
  ...
  insights : {
    ...
    description: null,
    cover: null,
    items: dummyInsightData,
  }
};

export default MlServiceDetailsData;

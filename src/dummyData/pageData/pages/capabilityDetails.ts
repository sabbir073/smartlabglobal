...
const capabilityDetailsData = {
  title: "AI Solutions for a Smarter Tomorrow",
  ...
  excerpt:
    "Empowering industries with scalable, amoral, and intelligent AI breakthroughs for practical applications.",
  content: "",
...
export default capabilityDetailsData;

...
export default function Error({
  ...
  useEffect(() => {
    /* @todo send the stack trace to Sentry, LogRocket, or any other log monitor, will be implemented later */
    console.error(error);
  }, [error]);
    ...
    <section className="h-screen w-full flex items-center justify-center">
      <div className="max-w-[570px] w-[90%] mx-auto">
        ...
        <div className="items-center justify-center text-center">
          ...
          <div className="mt-[16px] md:px-0 px-4 w-full mx-auto flex ">
            <input
              type="email"
              placeholder="Enter your email"
              className="px-4 py-2  w-[80%]  rounded-l-full focus:outline-none bg-[#EFEFEF]"
            />
            <ButtonComponent
              type="submit"

...
export default function ServiceAtGlanceTopLeftSplit({ data, containerClassName }: Props) {
  return (

    <TopLeftSplitedBanner showBackDrop backDropClassName="bg-black/28 backdrop-blur-[0]" bgImage={data?.cover} splitClassName="bg-[#E6E7E8]">
      <div className={cn("relative", containerClassName)}>
        ...
        <div className="lg:absolute relative 2xl:top-[10vw] xl:top-[3vw]">
